<%@ Page Title="" Language="C#" MasterPageFile="~/WelcomeMaster.Master" AutoEventWireup="true" CodeBehind="WelcomeAccountantLoginPage.aspx.cs" Inherits="SchoolProject.WelcomeAccountantLoginPage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
      <div class="main-panel" style="background-color:whitesmoke"> 
        <div class="main-content" style="background-color:whitesmoke">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="content-header">ACCOUNTANT LOGIN</div>
                    </div>
                </div>
