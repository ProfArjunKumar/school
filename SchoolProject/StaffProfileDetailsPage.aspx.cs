...
{
    public partial class StaffProfileDetailsPage : System.Web.UI.Page
    {
        SqlConnection Conn = new SqlConnection(ConfigurationManager.ConnectionStrings["SmsConnection"].ConnectionString);
        protected void Page_Load(object sender, EventArgs e)
        {
            string q1 = "select * from StaffRegistration where Username='" + Session["Username"].ToString() + "'";
