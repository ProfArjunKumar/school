<%@ Page Title="" Language="C#" MasterPageFile="~/School.Master" AutoEventWireup="true" CodeBehind="Attendence_staff.aspx.cs" Inherits="SchoolProject.Attendence_staff" %>
                ...
                <div class="row">
                 ...
                 <div class="col-md-6">
                  <div class="form-group">
                      <asp:label runat="server" ID="StaffID" Text="Staff Id"></asp:label>
                      <asp:DropDownList ID="DDstudent" AutoPostBack="true" class="form-control" OnSelectedIndexChanged="TxtStaffId_SelectedIndexChanged" runat="server">
                                    ...
                                    <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator10" ForeColor="Red" ControlToValidate="DDstudent" ErrorMessage="Please Enter Field" InitialValue="-1" />
