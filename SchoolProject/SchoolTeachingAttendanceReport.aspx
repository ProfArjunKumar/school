<%@ Page Title="" Language="C#" MasterPageFile="~/School.Master" AutoEventWireup="true" CodeBehind="SchoolTeachingAttendanceReport.aspx.cs" Inherits="SchoolProject.SchoolTeachingAttendanceReport" %>
        ...
        <div class="card-body">
          <div class="card-block">
           ...
           <fieldset>
              ...
              <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SmsConnection %>" SelectCommand="SELECT * FROM [StaffAttendance]" DeleteCommand="DELETE FROM [StaffAttendance] WHERE [Id] = @Id" InsertCommand="INSERT INTO [StaffAttendance] ([StaffId], [Date], [Name], [Department], [Status], [InTime], [OutTime]) VALUES (@StaffId, @Date, @Name, @Department, @Status, @InTime, @OutTime)" UpdateCommand="UPDATE [StaffAttendance] SET [StaffId] = @StaffId, [Date] = @Date, [Name] = @Name, [Department] = @Department, [Status] = @Status, [InTime] = @InTime, [OutTime] = @OutTime WHERE [Id] = @Id">
                  <DeleteParameters>
