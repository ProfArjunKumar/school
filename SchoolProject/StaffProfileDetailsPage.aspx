<%@ Page Title="" Language="C#" MasterPageFile="~/Staff.Master" AutoEventWireup="true" CodeBehind="StaffProfileDetailsPage.aspx.cs" Inherits="SchoolProject.StaffProfileDetailsPage" %>
    ...
    <fieldset>
        <div class="row">
           ...
           <strong>Alternate Contact No:</strong><asp:Label ID="Label6" runat="server"></asp:Label>
             ...
             <div class="col-md-6"> 
             <div class="form-group">
             <strong>Address :</strong><asp:Label ID="Label8" runat="server"></asp:Label>
             </div>
            </div>
              <div class="col-md-6">
             <div class="form-group">
            <strong>Email :</strong><asp:Label ID="Label7" runat="server"></asp:Label>
             </div>
            </div>
