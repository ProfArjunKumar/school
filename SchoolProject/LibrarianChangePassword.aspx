<%@ Page Title="" Language="C#" MasterPageFile="~/Librarian.Master" AutoEventWireup="true" CodeBehind="LibrarianChangePassword.aspx.cs" Inherits="SchoolProject.LibrarianChangePassword" %>
                            ...
                            <div class="card">
                                ...
                                <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator2" ForeColor="Red" ControlToValidate="txtpwd3" ErrorMessage="Please enter Confirm Password!" />
                                                    ...
                                                    <div class="col-md-8" style="margin-left:261px;">
                                                        <div class="form-group">
                                                            <asp:Button ID="SubmitButton" align="center" Text="Submit" runat="server" OnClick="saveForm_Click"  class="gradient-button gradient-button-1" />
                                                        </div>
                                                    </div>
