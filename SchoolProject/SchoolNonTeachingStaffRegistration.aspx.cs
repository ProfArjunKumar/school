...
{
    public partial class SchoolNonTeachingStaffRegistration : System.Web.UI.Page
    {
        ...
        private void autogenerated()
        {
            ...
            conn.Open();
            SqlCommand cmd = new SqlCommand("Select count(Staf_Id) from NonTech_Reg", conn);
            ...
            if (FileUpload1.HasFile)
                if (FileUpload2.HasFile)
                    if (FileUpload3.HasFile)
                    {
                        ...
                        SqlCommand cmd = new SqlCommand("insert into NonTech_Reg values (@Staf_Id,@Date,@FullName,@Gender,@Department,@Email,@Religion,@MaritalStatus,@JoiningDate,@ContactNo,@AltNumber,@Address,@Photo,@AddressProof,@Id_Proof,@Status,@Username,@Password)", con);
